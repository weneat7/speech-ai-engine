...
import com.cspl.common.gen_ai.speechaiengine.adaptors.provider_adaptor.IProviderAdaptor;
...
/**
 * Handler for the Plivo WebSocket connection.
 */
@Component
@Slf4j
@AllArgsConstructor
public class PlivoWebSocketHandler implements WebSocketHandler {

    /**
     * The provider incoming event handler factory to handle incoming events.
     */
    private final IProviderAdaptor plivoAdaptor;
    ...
    private void handleIncomingMessage(WebSocketMessage message , WebSocketSession providerSession) throws JsonProcessingException {
        Optional<IProviderIncomingEvent> providerEventOptional = plivoAdaptor.convertToCommonProviderEvent(message.getPayloadAsText());
    ...
    public void closeSession(String sessionId){
        log.info("Session {} closed with Plivo", sessionId);
